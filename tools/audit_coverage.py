    ...
    return [
        {
            ...
            "fetch": lambda: src.fetch_intel_data(offline=False),
        ...
        },
        {
            ...
            "fetch": lambda: src.fetch_uops_xml(offline=False),
        ...
        },
        {
            ...
            "fetch": lambda: src.fetch_arm_acle_data(offline=False),
        ...
        },
        {
            ...
            "fetch": lambda: src.fetch_arm_a64_data(offline=False),
        ...
        },
        {
            ...
            "fetch": lambda: src.fetch_riscv_rvv_intrinsics_data(offline=False),
        ...
        },
        {
            ...
            "fetch": lambda: src.fetch_riscv_unified_db_data(offline=False),
...
def _diff_source(spec: dict) -> dict:
    ...
    return {
        ...
        "used_fixture": getattr(version, "used_fixture", False),
